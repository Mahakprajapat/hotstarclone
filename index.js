let movies = [
  {
    name: "Loki",
    des: "Loki became the first Disney+ show from Marvel Studios to be officially confirmed for a Season 2 in its sixth episode’s post-credits scene, although details are scarce beyond that news. It’s been confirmed that the entire cast will return for the continuation of Loki’s Disney+ story after the Multiverse began falling apart to close out Season 1 in July 2021.",
  ...
  {
    name: "Wanda Vission",
    des: "Wanda basically has a mental breakdown that results in the death of her husband Vision, Hawkeye and a bunch of other people. In the famous House of M storyline on which this show is very loosely based, Wanda creates an alternate reality where Vision and the twins are alive, and they all live together.",
...
// let nextBtns = document.querySelector('.next-btn');
// let preBtns = document.querySelector('.pre-btn');
